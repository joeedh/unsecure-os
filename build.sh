...
i686-elf-gcc -fno-asynchronous-unwind-tables -funsigned-char -T linker.ld -o kernel.bin multiboot.o timer.o gdt.o kernel_main.o task.o master_irq_table.o interrupt_pointers.o interrupts.o libk.o list.o kmalloc.o printf.o tty.o keyboard.o cli.o tty_file.o fs_file.o process.o -ffreestanding -O2 -nostdlib  -lgcc -funsigned-char 
