...
source ./cflags.sh
i686-elf-gcc $CFLAGS _tinyext2_fs.c kernel/loader/*.c kernel/drivers/pci/*.c kernel/drivers/blockdevice/*.c \
...
i686-elf-gcc -g -DINIT_SECTION_ASM_OP=.init -fno-omit-frame-pointer -funsigned-char -T linker.ld -o build/kernel.bin core_x86.o timer.o gdt.o kernel_main.o bootinfo.o \
                                             ...
                                             ext2.o blockdevice.o libc.o \
                                             fprintf.o stdio.o cli.o \
                                             pci.o e9printf.o path.o elfloader.o \
